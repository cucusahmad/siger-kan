...
import { Building2, FileSpreadsheet, FlaskConical, Handshake, PackageSearch, Search } from "lucide-react";
...
export function ExecutiveReport({ data, initialSection }: ExecutiveReportProps) {
  ...
  return <div className="space-y-6">
    ...
    <section className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
      ...
      <div className="border-t border-slate-100 px-6 py-4 text-xs text-muted">Menampilkan {section === "businesses" ? businesses.length : section === "products" ? products.length : section === "matching" ? matches.length : testing.length} data</div>
    </section>
  </div>;
}
