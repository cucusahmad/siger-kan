...
export const productOfferInputSchema = z.object({
  productId: z.string().regex(/^\d+$/, "Produk tidak valid."),
  ...
  deliveryAddress: z.string().trim().min(10, "Alamat pengiriman minimal 10 karakter.").max(500),
...
export const productOfferActionSchema = z.object({
